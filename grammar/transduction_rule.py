...
src_to_target_grammar = {
    ...
    "S -> NPQ did NPVMod": "S -> NPVMod のは NPQ ですか",
    # what did A write and B edit? -> A ga kaite, B ga hennshushita no ha nann deshitaka
    ...
    "RC -> whose role VPMod": "RC -> role が VPMod",
...
src_to_target_grammar_ZH = {
    # S -> NPQ VP
    "S -> NPQ was Nominal": "S -> Nominal 是 NPQ",
    "S -> NPQ did NPVMod": "S -> NPV 的是 NPQ",
    "S -> was Nominal Vobl": "S -> Nominal 是 Vobl 的吗",
    "S -> was Nominal Adj": "S -> Nominal 是 Adj 吗",
    "S -> was NominalSub Nominal": "S -> NominalSub 是 Nominal 吗",
    "S -> did Nominal VP": "S -> Nominal VP 吗",

    #NPV -> Nominal V
    "NPV -> Nominal VPrep": "NPV -> VPrep 了 Nominal",

    "VP -> V Nominal": "VP -> V 了 Nominal",
    "VP -> was Vobl": "VP -> 被 Vobl",
    "VPrep -> was VPrep": "VPrep -> VPrep",
    "VPrep -> V by": "VPrep -> V",

    "Vobl -> VPrep Nominal": "Vobl -> Nominal VPrep",
    # NPQ -> WhW Nominal
    "NPQ -> WhW role caseO": "NPQ -> caseO WhW role",
    "commonNoun -> commonNoun RC": "commonNoun -> RC 的 commonNoun",
    # "RC -> Vobl"
    "RC -> R VP": "RC -> VP",
    "RC -> R NPV": "RC -> NPV",
    "RC -> whose role VP": "RC -> role VP",
    ...
    # VPx -> VPx punctVP
    # andVP -> conj VP
    "andVP -> punct conj VP":"andVP -> punct VP",
    # punctVP -> punct VP
    ...
    # andVobl -> conj Vobl
    "andVobl -> punct conj Vobl":"andVobl -> punct Vobl",
    # punctVobl -> punct Vobl

    # VPrep -> VPrep andVPrep
    # VPrep -> VPrepX andVPrep
    # VPrepX -> VPrep punctVPrep
    # VPrepX -> VPrepX pu  nctVPrep
    # andVPrep -> conj VPrep
    "andVPrep -> punct conj VPrep":"andVPrep -> punct VPrep",
